...
INITIAL_STORY_TEMPERATURE = 0.3  # Lower temperature for more focused, instruction-following responses
STORY_SEGMENT_TEMPERATURE = 0.3
CHARACTER_INTERACTION_TEMPERATURE = 0.3
