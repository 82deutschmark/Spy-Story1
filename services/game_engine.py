...
class GameState:
    ...
    def get_available_choices(self) -> List[Dict[str, Any]]:
        ...
        for choice in self.current_node.choices:
            ...
            affordable = self.user_progress.can_afford(choice.currency_requirements)
    ...
    def get_story_context(self) -> Dict[str, Any]:
        """Get current story context for the user"""
        if not self.current_node:
    ...
    def to_dict(self) -> Dict[str, Any]:
        """Convert current game state to dictionary for API communication"""
        return {
            ...
            "current_story_id": self.user_progress.current_story_id,
            "current_node_id": self.user_progress.current_node_id,
            "active_missions": [
                {
                    "id": mission.id,
                    "title": mission.title,
...
class GameEngine:
    ...
    def start_new_story(
        ...
        logger.info(f"Starting new story for user {user_id}")
